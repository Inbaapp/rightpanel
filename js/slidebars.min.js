...
(function(a) {
    a.slidebars = function(b) {
        ...
        function i(A) {
            ...
            function B() {
                if (r && A === "left" && e) {
                    a("html").addClass("sb-active sb-active-left ovx");
                    a("body").addClass("ovx")

                    /***Modifed By Inba***/

                    $("<div class='pageoverlay'>").appendTo('.ui-page-active');
                    ...
                    if (r && A === "right" && h) {
                        a("html").addClass("sb-active sb-active-right ovx");
                        a("body").addClass("ovx");
        ...
        function l(A) {
            if (g || j) {
                ...
                setTimeout(function() {
                    a("html").removeClass("sb-active sb-active-left sb-active-right ovx");
                    a("body").removeClass("ovx");
